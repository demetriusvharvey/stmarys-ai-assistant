...
export class FamilyCommunicationsAgent implements Agent {
  name = "family_communications" as const;
  displayName = "Family Communications";
  icon = "💌";
  mode = "family_communications" as const;
  ...
  async answer(request: AgentRequest): Promise<AgentResponse> {
    ...
    return {
      ...
      toolsUsed: [{
        ...
        success: true,
        inputSummary: "Family communications drafting.",
