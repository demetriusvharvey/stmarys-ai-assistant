...
export class TrainingEducationAgent implements Agent {
  name = "training_education" as const;
  displayName = "Training Education";
  icon = "🎓";
  mode = "training_education" as const;
  ...
  async answer(request: AgentRequest): Promise<AgentResponse> {
    ...
    return {
      ...
      toolsUsed: [{
        ...
        success: true,
        inputSummary: "Training and education requirements lookup.",
