...
export class QualityAssuranceAgent implements Agent {
  name = "quality_assurance" as const;
  displayName = "Quality Assurance";
  icon = "✅";
  mode = "quality_assurance" as const;
  ...
  async answer(request: AgentRequest): Promise<AgentResponse> {
    ...
    return {
      ...
      toolsUsed: [{
        ...
        success: true,
        inputSummary: "Quality assurance and incident report lookup.",
