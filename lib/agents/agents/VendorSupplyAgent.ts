...
export class VendorSupplyAgent implements Agent {
  name = "vendor_supply" as const;
  displayName = "Vendor Supply";
  icon = "📦";
  mode = "vendor_supply" as const;
  ...
  async answer(request: AgentRequest): Promise<AgentResponse> {
    ...
    return {
      ...
      toolsUsed: [{
        ...
        success: true,
        inputSummary: "Vendor and supply chain knowledge lookup.",
